...
* **Proximity Modification:** Runs standard linear timing differentials. Overdue tasks are pushed hardest (+35), with diminishing increments out to a rolling 7-day limit.
